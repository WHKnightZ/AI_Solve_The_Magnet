...
int Map[8][8];
int MB[8][8];
int X, Y, S, tmpX, tmpY, tmpX2, tmpY2, tmp, tmp2, MBC, mx, my;
...
void MainMenu() {
    ...
    setbkcolor(BGC);
    setcolor(5);
    outtextxy(115, 100, "The Magnet");
    settextstyle(3, 0, 2);
    setcolor(9);
    outtextxy(450, 175, "By KnightZ");
    setcolor(0);
    settextstyle(8, 0, 3);
    outtextxy(150, 480, "arrow keys to move");
    outtextxy(150, 510, "enter to action");
    outtextxy(150, 540, "r to restart");
    settextstyle(2, 0, 10);
    setcolor(1);
    outtextxy(205, 293, "#");
    outtextxy(470, 293, "#");
    outtextxy(250, 290, "new game");
    outtextxy(263, 360, "continue");
    while (true) {
        c = getch();
        switch (c) {
        case 72:
        ...
        case 77:
            setcolor(BGC);
            outtextxy(205, 293 + 70 * Choice, "#");
            outtextxy(470, 293 + 70 * Choice, "#");
            Choice = 1 - Choice;
            setcolor(1);
            outtextxy(205, 293 + 70 * Choice, "#");
            outtextxy(470, 293 + 70 * Choice, "#");
                    ...
                    for (int i = 0; i < 4; i++) {
                        if (BoolMove[i]) {
                            ...
                            if (Map[tmpY2][tmpX2] == 0 || Map[tmpY2][tmpX2] == 2) {
                                ...
                                BoolMove[i] = 0;
                                DoneMove++;
                                if (mb[MB[tmpY2][tmpX2]].getS() == mn.getS()) {
